module.exports = nativeDescription: "Català", englishDescription: "Catalan", translation:
  new_home:
    slogan: "La forma més atractiva d'aprendre a programar."
    classroom_edition: "Edició per a les classes:"
    learn_to_code: "Aprèn a programar:"
    play_now: "Juga ara"
    im_a_teacher: "Sóc Docent"
    im_a_student: "Sóc Estudiant"
    learn_more: "Saber-ne més"
    classroom_in_a_box: "Una classe 'tot en un' per ensenyar informàtica."
    codecombat_is: "CodeCombat és una plataforma <strong>per l'alumnat</strong> per aprendre informàtica tot jugant a un joc real."
    our_courses: "Els nostres cursos han estat especialment disenyats per a <strong>ser excel·lents a l'aula</strong>, fins i tot per a docents amb poca experiència en programació."
    top_screenshots_hint: "L'alumnat tecleja codi i veu en tems real els canvis fets"
    designed_with: "Disssenyat pensant en els docents"
    real_code: "Real, codi escrit"
    from_the_first_level: "des del primer nivell"
    getting_students: "Acostumar l'alumnat al codi escrit amb la major rapidesa possible és fonamental per aprendre la sintaxi de programació i les estructures adients."
    educator_resources: "Recursos per a docents"
    course_guides: "i guies dels cursos"
    teaching_computer_science: "L'ensenyament de la informàtica no requereix un grau costós, ja que proporcionem eines per donar suport als docents de tots els àmbits."
    accessible_to: "Accessible per a"
    everyone: "tothom"
    democratizing: "Democratitzar el procés d'aprenentatge de programació és el nucli de la nostra filosofia. Tothom ha de poder aprendre a programar."
    forgot_learning: "Crec que fins i tot no se n'adonen que estan aprenent coses."
    wanted_to_do: " Sempre he volgut aprendre a programar, i mai vaig pensar que ho podria fer a classe."
    builds_concepts_up: "M'agrada com CodeCombat va construint els conceptes. Realment és fàcil d'entendre i divertit de comprovar."
    why_games: "Per què es important aprendre mitjançant jocs?"
    games_reward: "Els jocs recompensen la lluita productiva."
    encourage: "El joc és un mitjà que afavoreix la interacció, el descobriment i l'assaig-error. Un bon joc desafia el jugador a dominar les habilitats al llarg del temps, que és el mateix procés crític que passa l'alumnat a mesura que aprèn."
    excel: "Els jocs són excel·lents en recompensar"
    struggle: "la lluita productiva"
    kind_of_struggle: "el tipus de lluita que resulta en l'aprenentatge que és atractiu i"
    motivating: "motivador"
    not_tedious: "no tediós."
    gaming_is_good: "Els estudis suggereixen que el joc és bo per als cervells infantils. (De debó!)"
    game_based: "Quan els sistemes d'aprenentatge basats en jocs són"
    compared: "comparats"
    conventional: "en contraposició dels mètodes d'avaluació convencionals, la diferència és clara: els jocs són millors per ajudar l'alumnat a retenir el coneixement, concentrar-se i"
    perform_at_higher_level: "actuar amb un nivell de rendiment major"
    feedback: "Els jocs també proporcionen retroalimentació en temps real que permet a l'alumnat ajustar la ruta de la solució i comprendre els conceptes de manera més holística, en comptes de limitar-se a respostes 'correctes' o 'errònies'."
    real_game: "Un joc real, jugat amb la codificació real."
    great_game: "Un gran joc és més que simples emblemes i èxits - es tracta del viatge d'un jugador, trencaclosques ben dissenyats i la capacitat d'abordar els desafiaments amb agilitat i confiança."
    agency: "CodeCombat és un joc que dona als jugadors l'agilitat i la confiança amb el nostre robust motor de codis tipogràfics, que ajuda l'alumnat principiant i avançat a escriure el codi correcte i vàlid."
    request_demo_title: "Invita avui mateix el teu alumnat!"
    request_demo_subtitle: "Sol·licita una demo i comença a jugat amb els teus alumnes en menys d'una hora."
    get_started_title: "Configura avui la teva classe"
    get_started_subtitle: "Configura una classe, afegeix els teus alumnes, i controla el seu progrés mentre ells aprenen informàtica."
    request_demo: "Sol·licita una Demo"
    setup_a_class: "configura una Classe"
    have_an_account: "Tens un compte?"
    logged_in_as: "Ara mateix has iniciat la sessió com a"
    computer_science: "Els nostres cursos autonoms cobreixen des de la sintaxi bàsica als conceptes més avançats"
    ffa: "Gratuït per tot l'alumnat"
    coming_soon: "Aviat, més!"
    courses_available_in: "Els coursos estan disponibles en JavaScript i Python. Els cursos de desenvolupament web utilitzen HTML, CSS i jQuery."
    boast: "Compta amb endevinalles que són prou complexas per fascinar als jugadors i als codificadors."
    winning: "Una combinació guanyadora del joc de rol i la tasca de programació que fa que l'acció educativa sigui legítimament agradable."
    run_class: "Tot el que necessites per dirigir una classe d'informàtica al teu centre avui dia, sense necessitat de tenir molts coneixements informàtics."
    goto_classes: "Ves a Les Meves Classes"
    view_profile: "Veure El Meu Perfil"
    view_progress: "Veure Progrés"
    go_to_courses: "Anar a Els Meus Cursos"
...
#    parent: "Parents"
  ...
  diplomat_suggestion:
    ...
    missing_translations: "Fins que puguem traduir-ho tot en català, ho veuràs en anglès quan no estigui en català."
...
#    loading_start_concept: "Start Concept Challenge"
    ...
    tip_open_source: "CodeCombat és 100% codi lliure!" # {change}
...
#    priority: "Priority"
  ...
  contribute:
    ...
    intro_blurb: "CodeCombat és 100% codi obert! Una gran quantitat de jugadors ens han ajudat a construir el joc tal com és avui. Uneix-te a l'aventura d'ensenyar a programar!" # {change}
...
#    you_can3: "that can be applied to your own account or given to others."
  ...
  loading_error:
    could_not_load: "Error de carrega del servidor" # {change}
